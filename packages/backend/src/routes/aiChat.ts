...
// gemini-2.5-flash-lite es el modelo actual estable más económico.
// Los modelos anteriores ('gemini-2.0-flash-lite' y 'gemini-3.1-flash-lite-preview')
// fueron deprecados y devuelven 404.
