...
import reposicionRouter from './routes/reposicion';
import alertasPrecioRouter from './routes/alertas-precio';
...
businessApi.use('/reposicion', reposicionRouter);
businessApi.use('/alertas-precio', alertasPrecioRouter);
businessApi.use('/sesiones', sesionesRouter);
